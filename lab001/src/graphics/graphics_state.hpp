...
public:
    t_x11_state();
    ~t_x11_state();
    t_x11_state(const t_x11_state&) = delete;
    t_x11_state(t_x11_state&&) = default;
    t_x11_state& operator=(const t_x11_state&) = delete;
    t_x11_state& operator=(t_x11_state&&) = default;
